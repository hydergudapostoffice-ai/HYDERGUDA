...
export default function App() {
  ...
  <div className="mt-4 text-slate-500">
    <i className="fa-solid fa-arrow-down text-xl animate-bounce"></i>
          ...
          <section
            id="selection"
            className="px-4 pt-16 pb-24 max-w-4xl mx-auto"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-sm text-slate-400 mb-6">
                  ...
                  The gold standard of insurance with the highest bonus rates.
                </p>
              ...
              >
                ...
                <p className="text-sm text-slate-400 mb-6">
                  High-return protection designed for rural families.
                  Small savings today, strong maturity tomorrow.
                </p>
